...
const Watch = ({
  ...
  const clickEnd = () => {
    dispatch(incrementEpisode());
    console.log(animeId, episode);
  };

  const [userTime, setUserTime] = useState(100);
  const [items, setItems] = useState([]);

  const introTimeHandler = () => {
    ...
    <>
      ...
      <div className="space-x-4 sm:mt-4 lg:flex">
        ...
        <div className="mx-auto flex flex-col items-center">
          <h1 className="m-3 text-base font-semibold text-red-500 sm:text-lg md:text-xl lg:mt-0 lg:text-2xl xl:text-3xl 2xl:text-4xl">
            Video Player Instructions
          </h1>
          <h1 className="m-3 text-base font-semibold text-white sm:text-lg md:text-xl lg:mt-0 lg:text-2xl xl:text-3xl 2xl:text-4xl">
            Press Q To Skip The Intro
          </h1>
          <h1 className="m-3 text-base font-semibold text-white sm:text-lg md:text-xl lg:mt-0 lg:text-2xl xl:text-3xl 2xl:text-4xl">
            Press W To Play The Video
          </h1>
          <h1 className="m-3 text-base font-semibold text-white sm:text-lg md:text-xl lg:mt-0 lg:text-2xl xl:text-3xl 2xl:text-4xl">
            Press E To Pause The Video
          </h1>
          <button
            className="m-3 text-base font-semibold text-blue-500 sm:text-lg md:text-xl lg:mt-0 lg:text-2xl xl:text-3xl 2xl:text-4xl"
            onClick={clickEnd}
          >
            Click Here To Skip The Ending
          </button>
          <h1 className="m-3 text-base font-semibold text-blue-500 sm:text-lg md:text-xl lg:mt-0 lg:text-2xl xl:text-3xl 2xl:text-4xl">
            Submit your intro skip
          </h1>
          ...
          <div className="flex items-center">
            ...
            <button
              className="m-3 text-base font-semibold text-blue-500 sm:text-lg md:text-xl lg:mt-0 lg:text-2xl xl:text-3xl 2xl:text-4xl"
              onClick={introTimeHandler}
            >
              Click to submit
            </button>
          </div>
          <h1 className="m-3 text-center text-base font-semibold text-blue-500 sm:text-lg md:text-xl lg:mt-0 lg:text-2xl xl:text-3xl 2xl:text-4xl">
            What to enter ? <br /> 100 - 1:42 <br /> 200 - 3:20 <br /> 300 -
            5:00 <br /> You can experiement with other number yourself
          </h1>
        </div>
      </div>
    </>
